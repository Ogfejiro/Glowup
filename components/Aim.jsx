  ...
  return (
    <div>
      <div className="text-center pt-12 pb-12">
        <h1 className="pb-4 font-bold text-xl" data-aos="fade-left">Aim</h1>
        ...
        <div className="padding-x pt-10">
          <p className="padding-x">By staying true to these aims and objectives, we strive to be a leader in the electrical industry, delivering exceptional value to our clients and contributing positively to the community.</p>
        </div>
      </div>
    </div>
  );
