  ...
  return (
    <section className="bg-hero-pattern bg-cover bg-center bg-fixed opacity-80" >
         <div className='text-center text-white'>
            <h1 className='pt-10 pb-10 text-2xl '>Services</h1>
            <p className='padding-x'>We offer services tailored to meet your unique needs. Whether you're outfitting your home, upgrading your business infrastructure, or tackling a large-scale project, our team of experienced professionals is here to ensure quality, safety, and reliability.</p>
